...
```{r FigS9}
knitr::include_graphics("Figures/Haplotype_structure_figure.png")
```
...
```{r FigS10,fig.width = 8,fig.height=4}
...
ggplot(aes(x = log10(MEAN_cM+1),y = meanRsb,col = outlier))+
  geom_point() + 
  theme_bw() +
...
**Figure S10** *Rsb* in relation to recombination in three pairwise comparisons, averaged across 500kb windows. Red points represent the top 1% of FST outliers.
