...
Fig5 <- dw %>%   filter(scaffold != 36,
  ...
  theme(legend.position = "none")+
    geom_point(col = "grey")+
  geom_point(data = outlier_lines,aes(x = log10(MEAN_cM+1),y = zFST,col = outlier_type))+
