...
**Figure 5** Genomic differentiation and recombination rate variation in European great tit populations. Each point is the mean of a 500kb window, with each panel displaying a pairwise comparison with the proposed refugial population in Turkey. Coloured points represent $F_{ST}$ outliers (mean standardized $F_{ST}$ values of $zF_{ST}$ > 10) shared across more than two comparisons (red), or specific to one or two comparisons (dark blue). Solid and dotted lines represent median and 99% quantiles of $F_{ST}$ windows from bins of 0.1 log cM
