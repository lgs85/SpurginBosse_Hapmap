...
Fig1 <- get_map(location = 'Europe', zoom = 4,maptype="roadmap", color="bw") %>%
ggmap()+ 
...
multiplot(Fig1A,Fig1A,Fig1C,layout = matrix(c(1,2,3,3),nrow = 2,byrow = T))

```
**Figure 2** Admixture and treemix
